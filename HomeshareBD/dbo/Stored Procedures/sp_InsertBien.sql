CREATE PROCEDURE [dbo].[SP_InsertBien]
	...
	@idMembre INT
AS
	INSERT INTO [BienEchange](BienEchange.[Titre], [DescCourte], [DescLong], [NombrePerson], [Pays], [Ville], [Rue],[Numero], [CodePostal], [Photo], [AssuranceObligatoire], [isEnabled], [Latitude], [Longitude],[DateCreation], [idMembre])
